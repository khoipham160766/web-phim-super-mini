...
const GenreTvFilm = ({ itemsPerPage }) => {
  ...
  useEffect(()=>{
    const getListFilmToType = async() => {
      const response = await axios.get(`https://api.themoviedb.org/3/tv/airing_today?api_key=${key_api}&language=en-US&page=1`)
